...
public class Controller{
    ...
    */
     ...
     */
    public ItemScannedDTO registerItem(int regItem, double totPrice, List<Items> listOfItems) throws InvalidItemException{
	if (regItem == 0){
            // detta ska simulera att anslutningen till databasen inte funkar
            
            throw new DatabaseError("The server could not be reached (user)\n", "The server could not be reached (log)\n");
        }
        ...
        try{
            ...
            */
            ...
            int errorID = e.getItemID();
            
            throw new InvalidItemException(e.getItemID());
        }
    }
